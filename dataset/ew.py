...
class App:
        def __init__(self, master):
                frame = Frame(master)
                frame.pack()
                label1 = Label(frame, text="IP:", width = 10, height = 3)
                label1.grid(row = 0, column = 0)
                label2 = Label(frame, text="PORT:", width = 10, height = 3)
                label2.grid(row = 1, column = 0)
                label3 = Label(frame, text="WEB:", width = 10, height = 3)
                ...
                button1 = Button(frame, text='AAS', command = click_button)
                button1.grid(row = 3, column = 1)
                button2 = Button(frame, text='ASF', command = frame.quit)
